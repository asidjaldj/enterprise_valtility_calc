...
def process(quarter_source_data_files, result_data_dir, cache_dir, quarter):
    ...
    path_para = os.path.join(cache_dir, 'para_half_1.csv')
    ...
    path_para = os.path.join(cache_dir, 'para_half_2.csv')
    ...
    path_dataclean_2 = os.path.join(cache_dir, 'DataCleaning_quarterTwo_2.csv')
