...
def s_1(ztdj_path, qybg_paths, fzjg_paths, qygx_paths, qyb_paths, start_month):
    ...
    new_file  = new_file.loc[(new_file["djjg"].str[:4] == '4206')&(new_file["hydm"] == 'C')]
    new_file["city"] = "襄阳市"
...
"D:\编译器Python以及项目文件\python object\enterprise_valtility_calc"
"python test.py half_year_data_1 half_year_data_1/月底统计202406/主体登记20240626/exportsql.20240626105306.gbk.csv 2024-01 output"